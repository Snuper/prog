...
{
	return (exp(x) + y_mas[0] + y_mas[1]) / 3;
...
main()
{
	...
	bool good = false, test_all_mas = true;
...
//		cout << endl << "h = " << h << endl;
		...
		cout << endl << "ddddddddddddddddddddddddddddddddddd" << endl;
			...
			{
				cout << endl << " i = " << i << "  &&  i * 2 = " << i * 2 + 1 << "  n_shag = " << n_shag / 2 << " h =  " << h << endl;
				cout << endl << "y(h): " << prev_y_mas[i] << endl;
				cout << endl << "y(h/2): " << next_y_mas[i * 2 + 1] << endl;
				cout << endl << "Korektirovka: " << fabs(prev_y_mas[i] - next_y_mas[i * 2 + 1]) << " < " << 15 * eps << endl;
				if(fabs((prev_y_mas[i] - next_y_mas[i * 2 + 1])) < (15 * eps)) test_all_mas = true; 
				else
				{
					cout << endl << "FALSE" << endl;
					cout << endl << " i = " << i << "  &&  i * 2 = " << i * 2 << "  n_shag = " << n_shag / 2 << " h =  " << h << endl;
					cout << endl << "y(h): " << prev_y_mas[i] << endl;
					cout << endl << "y(h/2): " << next_y_mas[i * 2 + 1] << endl;
					cout << endl << "Korektirovka: " << fabs(prev_y_mas[i] - next_y_mas[i * 2 + 1]) << " < " << 15 * eps << endl;
					test_all_mas = false;
