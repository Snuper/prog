...
// Включать в список полные квадраты из одномерного массива целых
// чисел (типа Byte). Удалить повторяющиеся элементы списка.
// Определить длину полученного списка.
//
// Задание 2 Написать программу, которая визуально демонстрирует работу
// стека и очереди. Длина стека и очереди ограничена 10 элементами.
