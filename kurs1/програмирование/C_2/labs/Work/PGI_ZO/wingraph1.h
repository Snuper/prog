// Исправлено для Visual Studio
// В настройках проекта, поставить "Использовать многобайтовую кодировку"
...
void WinGr::drawText(const int& nX, const int& nY, const char* psz, int color)
{
    ...
    #endif
	::TextOut(hDCMem, nX, nY, (LPCSTR)psz, strlen(psz));
}
...
int PASCAL WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR  lpCmdLine,  int  nShowCmd )
{
	...
	wc.lpszMenuName = (LPCSTR)"Menu_one";
	...
	hwnd = CreateWindow((LPCSTR)"NAME",               // имя класса окна
